...
import { RESERVATION_STATUS_LABEL, type Customer, type ReservationWithRelations } from "@/lib/types";
    ...
    <div className="max-w-2xl space-y-6">
      ...
      <div className="rounded-xl border border-border bg-card p-6 text-sm">
        ...
        <form action={updateCustomerMemo.bind(null, customer.id)} className="space-y-2">
          ...
          />
          <button type="submit" className="rounded-lg border border-border px-3 py-1.5 text-sm hover:bg-black/5">
            메모 저장
          </button>
        </form>
      </div>
